...
namespace SH3H.WAP.FieldWork.Share
{
    ...
    public static class SpellCodeHelper
    {
        ...
        public static string GetFirstPYCode(string transName)
        {
          ...
          "ф»ф…ф фЋфћфЌфќфѕф–ф—ф“ф”ф‘ф’ф÷ф„фЎфўфЏфџф№фЁфёфяфафбфвфгфдфефжфзфифйфкфлфмфнфофпфрфсфтфуфффхфцфчфшфщфъфыфьфэфюх°хҐх£х§х•х¶хІх®х©х™хЂхђх≠хЃхѓх∞х±х≤х≥хіхµхґхЈхЄхєхЇхїхЉхљхЊхњхјхЅх¬х√хƒх≈х∆х«х»х…х хЋхћхЌхќхѕх–х—х“х”х‘х’х÷х„хЎхўхЏхџх№хЁхёхяхахбхвхгхдхехжхзхихйхкхлхмхнхохпхрхсхтхухфхххцхчхшхщхъхыхьхэхюц°цҐц£ц§ц•ц¶цІц®ц©ц™цЂцђц≠цЃцѓц∞ц±ц≤ц≥ціцµцґцЈцЄцєцЇцїцЉцљцЊцњцјцЅц¬ц√цƒц≈ц∆ц«ц»ц…ц цЋцћцЌцќцѕц–ц—ц“ц”ц‘ц’ц÷ц„цЎцўцЏцџц№цЁцёцяцацбцвцгцдцецжцзцицйцкцлцмцнцоцпцрцсцтцуцфцхцццчцшцщцъцыцьцэцюч°чҐч£ч§ч•ч¶чІ" + "ч®ч©ч™чЂчђч≠чЃчѓч∞ч±ч≤ч≥чічµчґчЈчЄчєчЇчїчЉчљчЊчњчјчЅч¬ч√чƒч≈ч∆ч«ч»ч…ч чЋчћчЌчќчѕч–ч—ч“ч”ч‘ч’ч÷ч„чЎчўчЏчџч№чЁчёчячачбчвчгчдчечжчзчичйчкчлчмчнчочпчрчсчтчучфчхчцчччшчщчъчычьчэчю";
            ...
            for (int i = 0; i < transName.Length; i++)
            {
                ...
                {
                    if (transName[i].ToString().CompareTo("‘—") >= 0)
                        return_py += "z";
                    else if (transName[i].ToString().CompareTo("—є") >= 0)
                        return_py += "y";
                    else if (transName[i].ToString().CompareTo("ќф") >= 0)
                        return_py += "x";
                    else if (transName[i].ToString().CompareTo("ЌЏ") >= 0)
                        return_py += "w";
                    else if (transName[i].ToString().CompareTo("Ћъ") >= 0)
                        return_py += "t";
                    else if (transName[i].ToString().CompareTo("»ц") >= 0)
                        return_py += "s";
                    else if (transName[i].ToString().CompareTo("»ї") >= 0)
                        return_py += "r";
                    else if (transName[i].ToString().CompareTo("∆Џ") >= 0)
                        return_py += "q";
                    else if (transName[i].ToString().CompareTo("≈Њ") >= 0)
                        return_py += "p";
                    else if (transName[i].ToString().CompareTo("≈ґ") >= 0)
                        return_py += "o";
                    else if (transName[i].ToString().CompareTo("ƒ√") >= 0)
                        return_py += "n";
                    else if (transName[i].ToString().CompareTo("¬и") >= 0)
                        return_py += "m";
                    else if (transName[i].ToString().CompareTo("јђ") >= 0)
                        return_py += "l";
                    else if (transName[i].ToString().CompareTo("њ¶") >= 0)
                        return_py += "k";
                    else if (transName[i].ToString().CompareTo("їч") >= 0)
                        return_py += "j";
                    else if (transName[i].ToString().CompareTo("єю") >= 0)
                        return_py += "h";
                    else if (transName[i].ToString().CompareTo("ЄЅ") >= 0)
                        return_py += "g";
                    else if (transName[i].ToString().CompareTo("ЈҐ") >= 0)
                        return_py += "f";
                    else if (transName[i].ToString().CompareTo("ґк") >= 0)
                        return_py += "e";
                    else if (transName[i].ToString().CompareTo("іо") >= 0)
                        return_py += "d";
                    else if (transName[i].ToString().CompareTo("≤Ѕ") >= 0)
                        return_py += "c";
                    else if (transName[i].ToString().CompareTo("∞≈") >= 0)
                        return_py += "b";
                    else if (transName[i].ToString().CompareTo("∞°") >= 0)
                        return_py += "a";
                }
        ...
        /// ∞—ЇЇ„÷„™її≥…∆і“ф(»Ђ∆і)
        /// </summary>
        /// <param name="transName">ЇЇ„÷„÷ЈыіЃ</param>

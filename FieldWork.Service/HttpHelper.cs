...
namespace SH3H.WAP.FieldWork.Service
{
    ...
    public class HttpHelper
    {
        ...
        /// <returns></returns>
        public static string SendPost(string url, string data, HttpConfig config = null)
        {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static string SendGet(string url, string data, HttpConfig config = null)
        {
            return Send(url, "GET", data, config);
        }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static string SendPut(string url, string data, HttpConfig config = null)
        {
            return Send(url, "Put", data, config);
        }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static string SendDelete(string url, string data, HttpConfig config = null)
        {
            return Send(url, "Delete", data, config);
        }
        ...
        private static HttpWebResponse GetResponse(string url, string method, string data, HttpConfig config)
        {
            ...
            //请求头
            foreach (var item in config.AdditionHeader)
            {
    ...
    public class HttpConfig
    {
        ...
        /// 
        /// </summary>
        public Dictionary<string, string> AdditionHeader { get; set; }
        ...
        public HttpConfig()
        {
            ...
            this.AdditionHeader = new Dictionary<string, string>();
        }
    }
}
